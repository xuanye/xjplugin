;(function(window,undefined,$){
	...
	function __BuildPageNavition__(options){
		...
		if (options.page > 1) {
		    html.push("<li action='first'><a href='javascript:void(0)'>首页</a></li>");
		    html.push("<li action='prev'><a href='javascript:void(0)'>上一页</a></li>");
		}
		else {
		    html.push("<li class='disabled'><span style='color:#ddd;' >首页</span></li>");

		    html.push("<li class='disabled'><span style='color:#ddd;'>上一页</<span></li>");
		}
		...
		if (options.page < options.pages) {
		    ...
		    html.push("<li action='last'><a href='javascript:void(0)'>末页</a></li>");
		}
		else {
		    html.push("<li class='disabled'><span style='color:#ddd;'>下一页</span></li>");
		    html.push("<li class='disabled'><span style='color:#ddd;'>末页</span></li>");
		}
		html.push("</ul>");          
